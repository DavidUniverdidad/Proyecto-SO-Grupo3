...
namespace ProyectoSO
{
    public partial class START : Form
    {
        ...
        public void LlenarGrid2(string usuario, string respuesta)
        {
            ...
            if (respuesta=="SI")
            {
                ...
                dataGridView3.Rows[row].Cells[0].Value = usuario+" Acepta";
            }

            else
            {
                 dataGridView3.Rows.Add();
                 dataGridView3.Rows[row].Cells[0].Value = usuario + " Rechaza";
        ...
        {
            label5.Text = "Unirse a la partida de " + respuesta + "?";
            this.usuario_invitacion = respuesta;
        }
        private void AtenderServidor()
       {
        ...
        private void button1_Click(object sender, EventArgs e)//Conexión
        {
            ...
            IPAddress direc = IPAddress.Parse("192.168.56.106");//192.168.56.104, Local addr MV
                                                                //147.83.117.22 shiva server
            IPEndPoint ipep = new IPEndPoint(direc, 9089);//Puerto shiva 50076,50077,50078
